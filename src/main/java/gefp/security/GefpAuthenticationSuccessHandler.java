...
public class GefpAuthenticationSuccessHandler implements AuthenticationSuccessHandler{
    ...
    protected String determineTargetUrl(Authentication authentication) {
        ...
        for (GrantedAuthority grantedAuthority : authorities) {
            ...
            }  if (grantedAuthority.getAuthority().equals("advisor")) {
                isAdvisor = true;
